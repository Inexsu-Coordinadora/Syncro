...
const CrearConsultor_1 = require("../../../src/aplicacion/casosUso/consultor/CrearConsultor");
describe('CrearConsultor - Pruebas Unitarias', () => {
    ...
    beforeEach(() => {
        ...
        crearConsultor = new CrearConsultor_1.CrearConsultor(mockRepositorio);
    });
    test('Debe crear un consultor con datos válidos', async () => {
        const datosConsultor = {
...
//# sourceMappingURL=CrearConsultor.test.js.map